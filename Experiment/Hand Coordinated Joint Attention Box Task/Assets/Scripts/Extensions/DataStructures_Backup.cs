/*namespace MQ.MultiAgent
{
    ...
    public class HandData
    {
        ...
        public string LatestDataString()
        {
            ...
            output += (Hand.Position.x + "," + Hand.Position.y + "," + Hand.Position.z + "," + Hand.Rotation.eulerAngles.x + "," + Hand.Rotation.eulerAngles.y + "," + Hand.Rotation.eulerAngles.z + ",");
