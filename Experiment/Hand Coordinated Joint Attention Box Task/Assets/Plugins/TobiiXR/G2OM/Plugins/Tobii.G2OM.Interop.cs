...
namespace Tobii.G2OM
{
    ...
    public static class Interop
    {
        ...
        public const string g2om_lib = "libtobii_g2om";
        #else
        ...
        [DllImport(g2om_lib, CallingConvention = CallingConvention.Cdecl, EntryPoint = "g2om_set_eye_configuration")]
        public static extern G2OM_Error G2OM_SetEyeConfiguration(IntPtr context, G2OM_EyeConfiguration eye);
    ...
    public enum G2OM_Complexity
    {
        High = 0,   // The recommended level if the CPU budget can handle it
        Low,        // It will utilize the machine learning but at a limited level
        None,       // Similar time complexity of using a single raycast
    }

    public enum G2OM_EyeConfiguration
    {
        BothEyes = 0,  // This is the recommended configuration
        OnlyLeft,      // Only recommended if the eye tracker have problem tracking one eye
        OnlyRight,     // Only recommended if the eye tracker have problem tracking one eye
    }
    ...
    public struct G2OM_DeviceData
    {
        ...
        public G2OM_GazeRay leftEye;
        public G2OM_GazeRay rightEye;
    }
