...
namespace Tobii.Research.Unity
{
    public static class VRUtility
    {
        ...
        /// </summary>
        public static float LensCupSeparation
        {
            get
            {
        ...
        /// </summary>
        public static Transform EyeTrackerOriginVive
        {
            get
            {
                var cam = GameObject.FindGameObjectsWithTag("MainCamera");
                ...
                {
                    Debug.LogError("Too many Camera objects");
                    return null;
                }
                else
                {
                    return GetEyeTrackerOrigin(cam[0]);
                }
